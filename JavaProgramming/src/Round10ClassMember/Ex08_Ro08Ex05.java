...
public Ex08_Ro08Ex05(){
        ...
        do{
            ...
            if(jumin[2] * 10 + jumin[3] > 12){
                ...
                System.out.println("9,0,1,2,3,4 중 하나여야합니다.");
                continue;
            }
            ...
            if(temp1 != jumin[13]){
                System.out.println("주민 번호 검증 수가 올바르지 않습니다.");
                continue;
            }
            right = true;
        }while(!right);
       ...
       public void display(){
           ...
           switch(jumin[8]){
               ...
               case 1: area="대구"; break;
               case 2: area="마산"; break;
               case 3: area="부산"; break;
               case 4: area="대전"; break;
               case 5: area="광주"; break;
               case 6: area="울산"; break;
               case 7: area="목포"; break;
               case 8: area="여수"; break;
